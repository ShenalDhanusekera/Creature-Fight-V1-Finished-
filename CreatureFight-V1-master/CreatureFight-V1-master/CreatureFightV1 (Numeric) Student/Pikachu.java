...
{
    /**
     * Pikachu is a constructor for pikachu that will initialize the health and ownership of charmander.
    ...
    public void act() 
    {
        ...
        if( getHealthBar().getCurrent() <= 0)
        {
            ...
            getWorld().showText("Pikachu Has Fainted!",getWorld().getWidth()/2, getWorld().getWidth()/2 + 26);
