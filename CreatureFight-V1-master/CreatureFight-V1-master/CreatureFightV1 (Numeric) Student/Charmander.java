...
{
    /**
     * Charmander is a constructor for charmander that will initialize the health and ownership of charmander.
     * in this constuctor it will also resize the size of the picture 
     * 
     * @param Parameter is a world datatype that is called world. which is used to get the world
    ...
    public void act() 
    {
        ...
        if( getHealthBar().getCurrent() <= 0)
        {
            ...
            getWorld().showText("Charmander Has Fainted!",getWorld().getWidth()/2, getWorld().getWidth()/2 + 26);
